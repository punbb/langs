...
'Redirect time help'			=>	'當頁面做重新導向時所需等待的秒數。如果設為 0, 不會顯示導向頁面。',
...
'Show moderators'				=>	'顯示版面管理員',
'Show moderators label'			=>	'在首頁顯示版面管理員',
'Online list'					=>	'線上會員清單',
...
'User has posted label'			=>	'如果會員曾在某篇主題裡發表過文章，那麼這項功能會在該主題前加上一個圓點記號當作提示。如果您覺得開啟這項功能會造成您的伺服主機產生過多的負載，請取消這項功能。',
'Topic views'					=>	'主題點閱數',
...
'Features mask passwords'			=>	'密碼遮蔽',
'Features mask passwords legend'	=>	'不直接顯示密碼',
'Features mask passwords info'		=>	' 如果啟用此功能 PunBB 將不直接顯示出密碼 並且將在填寫密碼的下方增加一個確認密碼的欄位 如果關閉此功能 密碼將會直接被顯示出來 (您可以不理會此選項)。',
'Enable mask passwords'				=>	'啟用密碼遮蔽功能',
'Enable mask passwords label'		=>	'啟用表單密碼遮蔽功能',
