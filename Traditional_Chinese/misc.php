...
'Form e-mail errors'		=>	'<strong>警告！</strong> 在您的信件發送前，下列出現的錯誤必須做更正:',
'No e-mail subject'			=>	'請輸入信件主旨。',
...
'Write e-mail'				=>	'撰寫電子郵件',
'Send forum e-mail'			=>	'寫下您的郵件內容然後透過論壇發信功能寄給 %s',
...
'Too long reason'           =>  '您的報告字數為%s字 超出了%s字的限制',
'Report errors'             =>  '<strong>警告!</strong> 在您的信件發送前，下列出現的錯誤必須做更正:', 
...
'Moderate forum'			=>	'管理版面',
'Select'					=>	'勾選',	// the header of a column of checkboxes
'Move'						=>	'移動',
'Merge'						=>	'合併',
'Open'						=>  '開啟',
'Close'						=>  '關閉',
...
// Hostname lookup
'Hostname lookup'			=>	'IP 位址: %1$s<br />主機名稱: %2$s<br /><br />%3$s',
'Show more users'			=>	'顯示更多使用這組 IP 的會員',

// Moderate forum
'Moderate forum head'		=>	'版面管理 : %s',
'Topics'					=>	'主題',
'Move topic'				=>	'移動主題',
'Move topics'				=>	'移動主題',
'Merge topics'				=>	'合併主題',
...
// Moderate topic
'Posts'						=>	'文章',
'Delete posts'				=>	'刪除被勾選的文章',
'Split posts'				=>	'分離被勾選的文章',
'Delete whole topic'		=>	'刪除整個主題',
'Moderate topic head'		=>	'管理主題 : %s',
'New subject'				=>	'新主題標題:',
'Select post'				=>	'勾選文章', // Label for checkbox
'Confirm post delete'		=>	'確認刪除所有被勾選的文章',
'Confirm topic delete'		=>	'確認刪除所有被勾選的主題',
