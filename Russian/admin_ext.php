...
'Maxtestedon warning'			=> 'Данное расширение не тестировалось на этой версии PunBB и может быть с ней несовместимо.',
...
'Missing dependency'			=> 'Это расширение не может быть установлено, пока «%s» не установлен и не включен',
