...
'Installed extensions warn'		=>	'<strong>ВНИМАНИЕ!</strong> Если вы удалите расширение, то данные, связанные с ним будут удалены из базы данных и не смогут быть восстановлены путем повторной установки. Если вы хотите сохранить эти данные, то просто отключите это расширение.',
...
'Maxtestedon warning'			=>	'Данное расширение не тестировалось на этой PunBB и поэтому может быть несовместимо с текущей версией.',
...
'Hotfix download failed'		=>	'Ошибка загрузки и установки расширения. Пожалуйста, подождите несколько минут и попытайтесь снова.',
