...
'Reindex warning'			=>	'<strong>ВАЖНО!</strong> Обновление поискового индекса может занять продолжительное время и во время выполнения увеличит нагрузку на сервер. Если процесс будет прерван принудительно, то необходимо запомнить ID последней обработанной темы, чтобы продолжить процесс переиндексации с прерванного момента. Для этого нужно будет ввести ID+1 в поле «ID темы».',
