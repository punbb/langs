...
'E-mail flood'   			 => 'Должно пройти не менее %s секунд между отправками писем. Пожалуйста, подождите немного и попробуйте еще раз.',
...
'Report flood'  			 => 'Должно пройти не менее %s секунд между обращениями к модератору. Пожалуйста, подождите немного и попробуйте еще раз.',
