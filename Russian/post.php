...
'CSRF token mismatch'    => 'Обнаружена проблема безопасности. Скорее всего, прошло много времени с тех пор, как вы открыли страницу. Нажмите кнопку «Отправить» еще раз.',
'Invalid e-mail'		 => 'Неправильный адрес email.',
...
'Flood' 				 => 'Должно пройти не менее %s секунд между двумя сообщениями. Подождите немного и попытайтесь отправить сообщение еще раз.',
