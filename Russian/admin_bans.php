...
'E-mail/domain to ban label'	=> 'Блокировка по эл. почте',
'E-mail/domain help'			=> 'Адрес электронной почты или домен для блокировки (например, someone@example.ru или example.ru). Также смотрите пункт «Разрешить регистрацию с заблокированных адресов электронной почты» в Настройках/Регистрация для более подробной информации.',
...
'Advanced ban info' 			=> 'На следующей странице введите IP и адреса электронной почты. Если необходимо блокировать определенный IP-адрес, IP-диапазон или адрес электронной почты, то оставьте поле на этой странице пустым.',
...
'Reason'						=> 'Причина',
'No bans'   					=> 'Списко блокировок пуст.',
...
'Invalid e-mail message'		=> 'Введен неправильный адрес электронной почты (например, user@example.ru) или домен адресов электронной почты (например, example.ru).',
