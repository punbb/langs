...
'E-mail/domain help'			 => 'E-mail адрес или e-mail домен для блокировки(например someone@example.ru or example.ru). Также смотрите пункт "Разрешить регистрацию с заблокированных e-mail адресов" в Настройки/Регистрация для большей информации.',    //The e-mail or e-mail domain you wish to ban (e.g. someone@example.com or example.com). See "Allow registration with banned e-mail addresses" in Settings/Registration for more info.
...
'Advanced ban info' 			 => 'На следующей странице введите IP и e-mail адреса. Если хотите блокировать определенный IP-адрес, IP-диапазон или e-mail адрес, то оставьте поле на этой странице пустым.',    //The next page will let you enter a custom IP and e-mail. If you just want to ban a specific IP/IP-range or e-mail just leave the username on this page blank.
...
'No user username message'  	 => 'Нет зарегистрированных пользователей с этим именем. Если вы хотите добавить блокировку не привязанную к имени пользователя, оставьте поле пустым.',    //No user by that username registered. If you want to add a ban not tied to a specific username just leave the username blank.
'User is admin message' 		 => 'Этот пользователь — администратор и не может быть заблокирован. Если вы хотите заблокировать администратора, вы должны сначала перевести его в другую группу.',    //The user is an administrator and can't be banned. If you want to ban an administrator, you must first move him/her to any other user group.
'Must enter message'			 => 'Вы должны ввести хотя бы один из параметров блокировки: имя пользователя, IP-адрес или e-mail адрес.',    //You must enter at least one of the following pieces of information: a username, an IP address or an e-mail address.
'Invalid IP message'			 => 'Вы ввели неправильный IP-адрес или IP-диапазон.',    //You entered an invalid IP/IP-range.
'Can\'t ban guest user'			=>	'Гость не может быть заблокирован.',
'Invalid e-mail message'		 => 'Вы ввели неправильный e-mail адрес (например user@example.ru) или домен e-mail адресов(например example.ru).',    //The e-mail address (e.g. user@example.com) or partial e-mail address domain (e.g. example.com) you entered is invalid.
'Invalid expire message'		 => 'Вы ввели неправильный срок блокировки. Формат должен быть такой ГГГГ-ММ-ДД и она должна быть хотя бы на один день больше сегодняшней.',    //You entered an invalid expire date. The format should be YYYY-MM-DD and the date must be at least one day in the future.
