...
'Advanced ban info' 			 => 'На следующей странице введите IP и e-mail адреса. Если хотите блокировать определенный IP-адрес, IP-диапазон или адрес e-mail, то оставьте поле на этой странице пустым.',    //The next page will let you enter a custom IP and e-mail. If you just want to ban a specific IP/IP-range or e-mail just leave the username on this page blank.
...
'Must enter message'			 => 'Вы должны ввести хотя бы один из параметров блокировки: имя пользователя, IP-адрес или адрес e-mail.',    //You must enter at least one of the following pieces of information: a username, an IP address or an e-mail address.
...
'Invalid e-mail message'		 => 'Вы ввели неправильный адрес e-mail (например, user@example.ru) или домен адресов e-mail (например, example.ru).',    //The e-mail address (e.g. user@example.com) or partial e-mail address domain (e.g. example.com) you entered is invalid.
'Invalid expire message'		 => 'Вы ввели неправильный срок блокировки. Формат должен быть «ГГГГ-ММ-ДД», и дата должна быть хотя бы на один день больше сегодняшней.',    //You entered an invalid expire date. The format should be YYYY-MM-DD and the date must be at least one day in the future.
