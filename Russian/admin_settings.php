...
// Language definitions used in admin settings and install
...
'Report both label'				=>	'По внутренней системе уведомлений и используя электронную почту по списку рассылки.',
'Report email label'			=>	'Используя электронную почту по списку рассылки.',
...
'Reg e-mail group'				=>	'Адрес электронной почты регистрации',
'Allow banned label'			=>	'Разрешить регистрацию с адресом электронной почты, который заблокирован.',
'Allow dupe label'				=>	'Разрешить регистрацию с адресом электронной почты, который уже принадлежит другому пользователю.',
'Report new reg'				=>	'Оповещение по электронной почте',
...
'Display e-mail label'			=>	'Показывать адрес электронной почты другим пользователям.',
'Allow form e-mail label'		=>	'Скрывать адрес электронной почты, но разрешить отправлять почтовые сообщения через форум.',
'Disallow form e-mail label'	=>	'Скрывать адрес электронной почты и запретить отправлять почтовые сообщения через форум.',
...
'E-mail addresses legend'		=>	'Адреса электронной почты',
'Admin e-mail'					=>	'Электронная почта администратора',
'Webmaster e-mail label'		=>	'Электронная почта веб-мастера',
