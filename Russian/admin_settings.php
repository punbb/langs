...
'URL scheme info'				=>	'<strong>ВНИМАНИЕ!</strong> Если вы выберите схему, отличную от базовой, вы должны переименовать файл .htaccess.dist в корне форума в .htaccess. Сервер, на котором установлен форум, должен быть сконфигурирован с поддержкой mod_rewrite и должен разрешать использование файлов .htaccess. Если вы используете веб-сервер, отличный от Apache, пожалуйста обратитесь к документации данного сервера.',
