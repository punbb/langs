...
'Settings welcome'			=>	'Изменение настроек локализации, отображения и email',
'Settings welcome user'		=>	'Изменение настроек локализации, отображения и email',
...
'Notify full'				=>	'Включать копию текста сообщения в email уведомлениях.',
...
// Change E-mail stuff
'Change e-mail errors'		=>	'<strong>Внимание!</strong> Следующие проблемы препятствуют обновлению email адреса:',
...
'E-mail updated'			=>	'Ваш email адрес обновлён.',
'E-mail updated redirect'   =>  'Ваш email адрес обновлён. Перенаправление…',
'Wrong password'			=>	'Введённый пароль неверен.',
'Activate e-mail sent'		=>	'На указанный email адрес отправлено письмо с инструкциями по активации нового email адреса. Если письмо не пришло в течении суток, обратитесь к администратору форума: %s.',
'Change your e-mail'		=>	'Изменить email адрес',
'Change user e-mail'		=>	'Изменить email адрес',
'New e-mail'				=>	'Новый email адрес',
...
'E-mail not match'			=>	'Введённые email адреса не совпадают.',
'Banned e-mail'				=>	'E-mail адрес, введённый вами, заблокирован на этом форуме. Выберите другой.',
'Dupe e-mail'				=>	'Другой пользователь с таким email адресом уже зарегистрирован. Выберите другой.',
'Reg e-mail'				=>	'Благодарим за регистрацию. На указанный email адрес высланы инструкции по активации вашей учётной записи. Если письмо не пришло в течении суток, обратитесь к администратору форума: %s.',
'Reg complete'				=>	'Регистрация завершена.',
'Register errors'			=>	'<strong>Внимание!</strong> Следующие проблемы препятствуют регистрации:',
'E-mail info'				=>	'<strong>Важно!</strong> На ваш новый email адрес будет отправлено письмо, содержащее активационную ссылку. Для активации нового email адреса необходимо пройти по той ссылке. Рекомендуется проверить правильность введённой информации.',
'Reg e-mail info'			=>	'<strong>Важно!</strong> На указанный email адрес будет отправлено письмо, содержащее активационную ссылку. Для активации новой учётной записи адреса необходимо пройти по той ссылке. Вы должны активировать свой аккаунт в течение 72 часов, в противном случае ваш аккаунт будет удален.',
...
'E-mail'					=>	'E-mail',
'E-mail help'				=>	'Ваш настоящий email адрес.',
'Confirm e-mail'			=>	'Подтвердите email адрес',
'Confirm e-mail help'		=>	'В целях безопасности введите ваш email адрес ещё раз.',
'Optional legend'			=>	'Дополнительные настройки',
'Language'					=>	'Язык',
'Timezone'					=>	'Часовой пояс',
'DST label'					=>	'Переход на летнее/зимнее время.',
'E-mail settings'			=>	'Настройки email',
'E-mail setting 1'			=>	'Показывать ваш email адрес другим пользователям.',
'E-mail setting 2'			=>	'Скрыть ваш email адрес, но разрешить отправлять на него сообщения через форум.',
'E-mail setting 3'			=>	'Скрыть ваш email адрес и запретить отправлять на него сообщения через форум.',
...
'Invalid e-mail'			=>	'Введённый вами email адрес неверен.',
