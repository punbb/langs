...
'Change your e-mail'		=>	'Изменить адрес электронной почты',
'Change user e-mail'		=>	'Изменить адрес электронной почты',
...
'Confirm e-mail help'		=>	'В целях безопасности введите ваш адрес электронной почты ещё раз.',
...
'E-mail setting 1'			=>	'Показывать ваш адрес электронной почты другим пользователям.',
'E-mail setting 2'			=>	'Скрыть ваш адрес электронной почты, но разрешить отправлять на него сообщения через форум.',
'E-mail setting 3'			=>	'Скрыть ваш адрес электронной почты и запретить отправлять на него сообщения через форум.',
