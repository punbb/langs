...
'Settings welcome'			=>	'Изменение настроек локализации, отображения и эл. почты',
'Settings welcome user'		=>	'Изменение настроек локализации, отображения и эл. почты',
...
'Subscribe by default'		=>	'Автоматически подписывать на уведомления о новых сообщениях.',
...
'Reg e-mail info'			=>	'<strong>Важно!</strong> На указанный адрес электронной почты будет отправлено письмо, содержащее активационную ссылку. Для активации новой учётной записи адреса необходимо пройти по той ссылке. Вы должны активировать свой аккаунт в течение 72 часов, в противном случае ваш аккаунт будет удален.',
