...
// Avatar stuff
'Avatar welcome'			=>	'Установка аватара для повышения индивидуальности на форуме', //FIXME: нужно сказать это по-_русски_
'Avatar welcome user'		=>	'Установка аватара для повышения индивидуальности пользователя %s на форуме',
...
'Settings welcome user'		=>	'Изменение настроек локализации, отображения и e-mail пользователя %s',
...
'Sig welcome user'			=>	'Создание и изменение подписи пользователя %s',
