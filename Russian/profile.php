...
'E-mail info'				=>	'<strong>Важно!</strong> На ваш новый e-mail адрес выслано письмо содержащее активационную ссылку. Для активации нового e-mail адреса необходимо пройти по той ссылке. Рекомендуется проверить правильность введённой информации.',
'Reg e-mail info'			=>	'<strong>Важно!</strong> На указанный e-mail адрес выслано письмо содержащее активационную ссылку. Для активации новой учётной записи адреса необходимо пройти по той ссылке. Рекомендуется проверить правильность введённой информации.',
