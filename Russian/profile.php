...
'Delete posts info'			=>	'<strong>Warning!</strong> Если вы подтвердите не удалять сообщения пользователя, то сможете сможете удалить их позже вручную.',
...
// Avatar stuff
'Avatar welcome'			=>	'Установить аватар для повышения индивидуальности на форуме', //FIXME: нужно сказать это по-_русски_
'Avatar welcome user'		=>	'Установить аватар для повышения индивидуальности пользователя %s на форуме',
...
'Too wide or high'			=>	'Изображение, которое вы попытались загрузить шире и/или выше допустимых %sx%s пикселов.', //FIXME: нужно русское "pixels"
...
'Avatar info size'			=>	'Максимальный размер изображения - %sx%s пикселов и %s байт (%s КБ).',
...
'Identity welcome'			=>	'Изменение вашей личной и контактной информации',
'Identity welcome user'		=>	'Изменение личной и контактной информации пользователя %s',
'View your posts'			=>	'Показать ваши сообщения',
'View your topics'			=>	'Показать ваши темы',
'View user posts'			=>	'Показать сообщения пользователя %s',
'View user topics'			=>	'Показать темы пользователя %s',
'View your subscriptions'	=>	'Показать темы, на которые вы подписаны',
'View user subscriptions'	=>	'Показать темы, на которые подписан пользователь %s',
...
'Send forum e-mail'			=>	'Послать сообщение пользователю используя форум',
...
'Title'						=>	'Статус',
'Leave blank'				=>	'Для использования настроек форума по умолчанию оставьте незаполненным.',
...
'Settings welcome'			=>	'Изменение настроек языка, отображения и e-mail адреса',
'Settings welcome user'		=>	'Изменение настроек языка, отображения и e-mail адреса пользователя %s',
...
'Subscribe by default'		=>	'Автоматически включать уведомление о новых сообщениях в теме.',
...
'Change user password'		=>	'Изменить пароль пользователя %s',
...
'Change user e-mail'		=>	'Изменить e-mail адрес пользователя %s',
'New e-mail'				=>	'Новый e-mail адрес',

// Signatures
'Sig welcome'				=>	'Создание или изменение подписи',
'Sig welcome user'			=>	'Создание или изменение подписи пользователя %s',
...
'Signature'					=>	'Подпись',
'Compose signature'			=>	'Создание подписи',
...
'Reg e-mail info'			=>	'<strong>Важно!</strong> На указанный e-mail адрес послано письмо содержащее активациионную ссылку. Для активации новой учётной записи адреса необходимо пройти по той ссылке. Рекомендуется проверить правильность введённой информации.',
...
'DST label'					=>	'Переход на летнее/зимнее время (перевод часов на 1 час назад/вперёд).',
...
'Username BBCode'			=>	'Имя пользователя не должно содержать тегов для форматирования текста(BBCode), используемых на форуме. Выберите другое имя пользователя.',
'Username IP'				=>	'Имя пользователя не должно выглядеть как IP адрес(четыре набора цифр, разделённых точками). Выберите другое имя пользователя.',
'Username censor'			=>	'Выбранное имя пользователя содержит недопустимое слово. Выберите другое имя пользователя.',
'Username dupe'				=>	'Пользователь с таким именем пользователя существует. Имя пользователя должно отличаться как минимум на один символ (a-z, а-я, или 0-9). Выберите другое имя пользователя.',
'Username guest'			=>	'Имя пользователя guest зарегистрировано. Выберите другое имя пользователя.',
'Username reserved chars'	=>	'Имя пользователя не должно содержать символы  \', " и [(]). Выберите другое имя пользователя.',
'Username too long'			=>	'Имя пользователя не должно быть длиннее 25 символов. Выберите другое имя пользователя.',
'Username too short'		=>	'Имя пользователя должно содержать как минимум 2 символа. Выберите другое имя пользователя.',
'Signature quote/code'		=>	'Использование кавычек, HTML и BBCode тэгов в подписях запрещено.',
