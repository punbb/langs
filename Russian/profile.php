...
'Reg e-mail info'			=>	'<strong>Важно!</strong> На указанный e-mail адрес будет отправлено письмо, содержащее активационную ссылку. Для активации новой учётной записи адреса необходимо пройти по той ссылке. Вы должны активировать свой аккаунт в течение 72 часов, в противном случае ваш аккаунт будет удален.',
