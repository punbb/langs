...
'Group title label' 			 => 'Название группы',    //Group title
'User title label'  			 => 'Титул пользователей',    //User title
'Group title head'  			 => 'Заголовок группы и титул пользователей',    //Group and user title
'Group title legend'			 => 'Установка заголовков и титулов',    //Set titles
'Group perms head'  			 => 'Права пользователей группы',    //Group permissions
'Group flood head'  			 => 'Установка необходимых интервалов для пользователей группы',    //Group flood protection settings
'User title help'   			 => 'Этот титул перекроет любые ранги пользователям, которые будут включены в данную группу. Оставьте пустым, если не хотите менять ранги.',    //This title will override any rank users in this group have attained. Leave blank to use default title or rank.
...
'Allow post replies label'  	 => 'Резрешить написание ответов в темы.',    //Allow users to post replies in topics.
...
'Allow send email label'		 => 'Разрешить посылку e-mail сообщений другим пользователям.',    //Allow users to send e-mails to other users.
...
'Remove group'  				 => 'Удалить эту группу',    //Remove this group
'Edit group'					 => 'Редактировать эту группу',    //Edit this group
'default'   					 => '(по умолчанию)',    //(default)
'Cannot remove group'   		 => 'Это группа не может быть удалена.',    //This group cannot be removed.
'Cannot remove default' 		 => 'Чтобы удалить эту группу, вам надо назначить другую группу "по умолчанию".',    //To remove this group you must assign a new default group.
...
'Must enter group message'  	 => 'Вы должны ввести название группы.',    //You must enter a group title.
'Already a group message'   	 => 'Группа <strong>«%s»</strong> уже существует.',    //There is already a group with the title <strong>"%s"</strong>.
'Moderator default group'   	 => 'Это группа «по умолчанию» для новых пользователей и она не должна содержать модераторские права.',    //This is the default group for new users and therefore cannot be assigned moderator privileges.
