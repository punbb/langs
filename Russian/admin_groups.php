...
'User title help'   			 => 'Это название перекроет ранги пользователей, включенных в группу. Оставьте пустым, чтобы не менять ранги.',
...
'Allow mod edit username label'  => 'Разрешить изменение имен пользователей.',
...
'Allow send e-mail label'		 => 'Разрешить отправлять e-mail сообщения другим пользователям.',
...
'E-mail flood interval label'	 => 'Интервал между email сообщениями',
'E-mail flood interval help' 	 => 'Количество секунд, которое должно пройти между двумя email сообщениями пользователей из этой группы. Поставьте 0, чтобы выключить.',
...
'Existing groups intro' 		 => 'Предопределенные группы «Гости» и «Администраторы» не могут быть удалены, но их можно отредактировать. Помните, что в некоторых группах определенные настройки недоступны (например, право на редактирование сообщений для гостей). Администраторы всегда имеют полные права.',
