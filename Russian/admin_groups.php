...
'E-mail flood interval label'	 => 'Интервал между сообщениями по электронной почте',
'E-mail flood interval help' 	 => 'Количество секунд, которое должно пройти между двумя сообщениями по электронной почте пользователей из этой группы. Поставьте 0, чтобы выключить.',
