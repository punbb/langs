...
'Updates failed'			=>	'Последняя проверка обновлений на punbb.informer.com завершилась неудачно. Это может означать, что сервис обновлений перегружен или недоступен. Если данное предупреждение не исчезнет в течение одного-двух дней, вы можете отключить автоматическую проверку и проверять наличие обновлений вручную.',
'Updates version n hf'		=>	'Новая версия PunBB - %s доступна для загрузки на <a href="http://punbb.informer.com/">punbb.informer.com</a>. Кроме этого, есть одно или несколько исправлений к расширениям, доступные для установки на вкладке "Расширения" интерфейса администратора.',
'Updates version'			=>	'Новая версия PunBB - %s доступна для загрузки на <a href="http://punbb.informer.com/">punbb.informer.com</a>.',
'Updates hf'				=>	'Одно или несколько исправлений к расширениям доступно для установки на вкладке "Расширения" интерфейса администратора.',
...
'ATOM Feed'					=>	'Atom',
'RSS Feed'					=>	'RSS',
'RSS description'			=>	'Недавние темы форума "%s".',
